...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class GazeManager : Singleton<GazeManager>
    {
        ...
        /// </summary>
        public bool IsGazingAtObject { get; protected set; }
        ...
        /// Normal of the gaze.
        /// </summary>
        public Vector3 GazeNormal { get; protected set; }
        ...
        protected float lastHitDistance = 2.0f;

        /// <summary>
        /// Unity UI pointer event.  This will be null if the EventSystem is not defined in the scene.
        /// </summary>
        public PointerEventData UnityUIPointerEvent { get; protected set; }

        /// <summary>
        /// Cached results of racast results.
        /// </summary>
        protected List<RaycastResult> raycastResultList = new List<RaycastResult>();
        ...
        /// </summary>
        protected virtual GameObject RaycastPhysics()
        {
        ...
        protected RaycastResult FindClosestRaycastHitInLayermasks(List<RaycastResult> candidates, LayerMask[] layerMaskList)
        {
        ...
        protected int FindLayerListIndex(int layer, LayerMask[] layerMaskList)
        {
            for (int i = 0; i < layerMaskList.Length; i++)
            {
        ...
        protected bool IsLayerInLayerMask(int layer, int layerMask)
        {
            return ((1 << layer) & layerMask) != 0;
        }

        protected RaycastHit? PrioritizeHits(RaycastHit[] hits)
        {
            if (hits.Length == 0)
            {
                return null;
